			...
			<Row customClass="documentation-flex-row">
				<Column lg="3" sm="4">
					<Card customClass="documentation-card">
						<a
							href="https://wppool.dev/docs-category/how-to-use-sheets-to-wp-table/"
							target="_blank"
				...
				<Column lg="3" sm="4">
					<Card customClass="documentation-card">
						<a
							href="https://www.youtube.com/watch?v=hKYqE4e_ipY&list=PLd6WEu38CQSyY-1rzShSfsHn4ZVmiGNLP"
							target="_blank"
							className="single-doc-item"
						></a>
						{ videoPlay }
