 ...
 * Client class.
 *
 * @package Appsero on FormyChat.
 * @since 1.0.0
 */
namespace SWPTLSFree\Appsero;
...
class Client {
	...
	public function updater() {
		...
		_deprecated_function( __CLASS__ . '::updater', '2.0', '\SWPTLSFree\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

		// initialize the new updater.
		if ( method_exists( '\SWPTLSFree\Appsero\Updater', 'init' ) ) {
			\SWPTLSFree\Appsero\Updater::init( $this );
		}
	}
	 ...
	 *
	 * @param array  $params include params.
	 * @param string $route include route.
	 * @param bool   $blocking include $blocking.
	 *
	 ...
	 *
	 * @param string $textdomain include $textdomain.
	 */
