...
class Insights {
	 ...
	 *
	 * @param string $client include client.
	 * @param null   $name include name.
	 * @param null   $file include file.
	 */
	public function __construct( $client, $name = null, $file = null ) {
		...
		if ( is_object($client) && is_a($client, 'SWPTLSFree\Appsero\Client') ) {
			$this->client = $client;
		}
	}
	 ...
	 *
	 * @param bool $override include override.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string $post_type include post_type.
	 *
	 * @return int
	 */
	 ...
	 *
	 * @param array $schedules include schedules.
	 *
	 * @return array
	 */
	 ...
	 *
	 * @param array $links include links.
	 *
	 * @return array
	 */
	 ...
	 *
	 * @param string $new_name include new_name.
	 * @param object $new_theme include new_theme.
	 * @param object $old_theme include old_theme.
	 *
	 * @return void
	 */
